...
**works.html, work.html and contact.html sign off short** — copyright only, no address and no LinkedIn. Frank's instruction, page by page (works Sept 11, the project pages Sept 12, Contact Sept 13): the work pages are the work itself and the ways to reach him are one rung up the Navigate branch; Contact already lists every address in its body, so the footer was saying it twice. Only About keeps the full sign-off. **Do not "fix" it back.**
