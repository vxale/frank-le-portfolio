...
- Five real projects are in (Gái Đẹp Không Phải Buồn, TẤM CÁM BY MẢNH, Vision of Love — Moving Image; FCI Monthly News Recap and Winter Cries as It Says Goodbye — Poster Design — Design). Six `PLACEHOLDER` entries remain alongside them and the headshot is still to come.
