...
- Scale: brought **back down** Sept 8 2026 on Frank's instruction (the monumental hero "wasn't working"). `--step-3`/`--step-4` are a normal editorial range now; the 135-188px tier is gone and so is the earlier instruction not to shrink it.
